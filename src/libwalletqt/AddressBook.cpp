...
AddressBook::AddressBook(Electroneum::AddressBook *abImpl,QObject *parent)
...
QList<Electroneum::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Electroneum::AddressBookRow * AddressBook::getRow(int index) const
{
